                 ...
                 @endphp
                    ...
                    <div class="tab-pane fade {{$cat_class}}" id="cat{{$item->id}}">
                      <ul class="aa-product-catg">
                        ...
                        @foreach ($home_categories_product[$item->id] as $item)
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img width="240" src="{{asset('storage/media')."/".$item->image}}" alt="polo shirt img"></a>
            ...
            <div class="aa-popular-category-area">
             ...
             <ul class="nav nav-tabs aa-products-tab">
              ...
              <div class="tab-content">
                ...
                <!-- / latest product category -->              connoiseur 
              </div>
            </div>
          </div> 
        </div>
